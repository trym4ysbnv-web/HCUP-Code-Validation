# ================================================================
# NIS 2019 FINAL PROCEDURE + MH-PCS ANALYSIS
# Adults age 18-64
#
...
cat("\nNIS 2019 FINAL PROCEDURE + MH-PCS ANALYSIS — AGE 18-64\n")

cat("\nSTEP 1 OF 2: Select NIS_2019_Core_function.R\n")
core_function_file <- file.choose()
source(core_function_file)
if(!exists("NIS_2019_Core_function")) stop("NIS_2019_Core_function not loaded.")

cat("\nSTEP 2 OF 2: Select NIS_2019_Core.ASC\n")
core_file <- file.choose()

NIS_2019_Core <- read.table(core_file,header=FALSE,sep=",",
                            stringsAsFactors=FALSE,quote="",comment.char="")
D <- NIS_2019_Core_function(NIS_2019_Core)
rm(NIS_2019_Core); gc()
...
required <- c(dx,pr,"AGE","DISCWT","I10_NPR","DRG")
...
fwrite(Cohort_Audit,file.path(output_dir,"NIS_2019_AGE18_64_MH_PCS_01_Cohort_Audit.csv"))
fwrite(MH_Overall_Summary,file.path(output_dir,"NIS_2019_AGE18_64_MH_PCS_02_Overall_Summary.csv"))
fwrite(MH_Domain_Summary,file.path(output_dir,"NIS_2019_AGE18_64_MH_PCS_03_Service_Domains.csv"))
fwrite(MH_Prefix_Breakdown,file.path(output_dir,"NIS_2019_AGE18_64_MH_PCS_04_Individual_Prefixes.csv"))
fwrite(MH_Treated_Intensity,file.path(output_dir,"NIS_2019_AGE18_64_MH_PCS_05_Treated_Intensity.csv"))
fwrite(Complexity_x_MH,file.path(output_dir,"NIS_2019_AGE18_64_MH_PCS_06_Complexity_x_MH.csv"))
fwrite(MH_DRG_x_MH_PCS,file.path(output_dir,"NIS_2019_AGE18_64_MH_PCS_07_MH_DRG_x_MH_PCS.csv"))
fwrite(MH_Count_Distribution,file.path(output_dir,"NIS_2019_AGE18_64_MH_PCS_08_MH_Count_Distribution.csv"))
fwrite(Overall_Procedure_Bins,file.path(output_dir,"NIS_2019_AGE18_64_MH_PCS_09_Overall_Procedure_Bins.csv"))
fwrite(Procedure_Bin_QA,file.path(output_dir,"NIS_2019_AGE18_64_MH_PCS_10_Procedure_Bin_QA.csv"))

cat("\nDONE: 10 validated NIS age 18-64 outputs written to",output_dir,"\n")
